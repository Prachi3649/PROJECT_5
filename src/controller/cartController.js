...
const updateCart = async (req, res) => {
    try {
        ...
        //     return res.status(400).send({status:false, message:"Provide removeProduct either 1 or 0"})
        // }
        ...
        if (removeProduct == 0) { 
            ...
            let flag = 0
            for (i = 0; i < (getCart.items.length); i++) { 
            ...
            let totalPriceOfSelectedProduct = getQuantityOfProduct * getProduct.price 
        ...
        } else { return res.status(400).send({status:true, message:"Please Provide removeProduct"})}
